  ...
  return (
    ...
    >
      <g clipPath="url(#a)" filter="url(#b)">
        ...
        <path
          fill="currentColor"
          d="M82.987 153.343a7.296 7.296 0 0 1-5.175-2.143l-34.146-34.144a7.315 7.315 0 0 1 5.178-12.477 7.32 7.32 0 0 1 5.17 2.129l28.973 28.97 63.118-63.115a7.316 7.316 0 0 1 10.347 10.347L88.16 151.2a7.288 7.288 0 0 1-5.173 2.143Z"
        />
        <path
          fill="currentColor"
          fillOpacity=".5"
          d="M82.957 153.343a7.296 7.296 0 0 0 5.175-2.143l34.146-34.144a7.313 7.313 0 0 0-.014-10.333 7.32 7.32 0 0 0-10.334-.015l-28.973 28.97L19.84 72.563A7.317 7.317 0 0 0 9.49 82.91l68.293 68.29a7.29 7.29 0 0 0 5.173 2.143Z"
        />
      </g>
      <defs>
        <clipPath id="a">
          <path fill="currentColor" d="M0 0h165v165H0z" />
        </clipPath>
        <filter
          id="b"
          width="167.163"
